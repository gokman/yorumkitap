...
public class DeleteCommentActionWS extends AsyncTask<Object, Void, String> {
    	...
    	public static String POST(String url,Comment comment){
    	       ...
    	       InputStream inputStream = null;
    	        ...
    	        try {
                    ...
                    jsonum.put("commentId", comment.getCommentId());
